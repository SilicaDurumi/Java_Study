...
public class ManagementSystem extends JFrame {
	...
	private Object[][] userdata = {}; //vector
	private Vector<String> columnNameVector = new Vector<String>() ;
	private String [] columnNameStr = {"Number", "Name", "Tel", "E-mail", "ID_Number"
			, "Age", "Gender", "Location",
			"Birth", "job"};
	...
	private int i, updateRow; // for loop variable
	...
	public ManagementSystem() {
		...
		for (i = 0; i < columnNameStr.length; i++) {
			alignCheckItem[i] = new JCheckBoxMenuItem(columnNameStr[i]);
		...
		editBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				EditFunction.UpdateData(table, jFrame);
			}
		});
